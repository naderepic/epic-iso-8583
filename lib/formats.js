...
const formats = {
    ...
    '127.25.7': {
      ContentType: 'ans',
      Label: 'Application Usage Control',
      LenType: 'fixed',
      MaxLen: 4
    },
    '127.25.8': {
    ...
    '127.25.16': {
      ContentType: 'an',
      Label: 'Interface Device Serial Number',
      LenType: 'fixed',
      MaxLen: 8
    },
    '127.25.17': {
    ...
    '127.25.35': {
      ContentType: 'ans',
      Label: 'Customer Exclusive Data (CED)',
      LenType: 'fixed',
      MaxLen: 64
    },
    '127.25.36': {
      ContentType: 'ans',
      Label: 'Form Factor Indicator',
      LenType: 'fixed',
      MaxLen: 8
    },
    '127.26': {
    ...
    '127.41': {
      ContentType: 'ans',
      Label: 'Originating Remote Address',
      LenType: 'llvar',
      MaxLen: 99
    },
    '127.42': {
    ...
    '127.44': {
      ContentType: 'ans',
      Label: 'Extended Card Acceptor Terminal ID',
      LenType: 'llvar',
      MaxLen: 25
    },
    '127.45': {
      ContentType: 'ans',
      Label: 'Extended Card Acceptor ID Code',
      LenType: 'llvar',
      MaxLen: 25
    },
    '127.46': {
      ContentType: 'ans',
      Label: 'Original Card Acceptor Terminal ID',
      LenType: 'fixed',
      MaxLen: 8
    },
    '127.47': {
      ContentType: 'ans',
      Label: 'Original Card Acceptor ID Code',
      LenType: 'fixed',
      MaxLen: 15
    },
    '128': {
