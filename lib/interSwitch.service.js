...
const reversalMessage = require('../tests/reversalMessage');
...
const connectToIswServer = () => {
  if (!client) {
    ...
    client.on('data', function (data) {
      ...
      if (responseMessage[0] === '0210') {
        const acquirerInstitutionIdCode = responseMessage[32];
        const forwardingInstitutionIdCode = responseMessage[33];
        const originalData = {
          messageType: '0200',
          stan: responseMessage[11],
          transmissionDateTime: responseMessage[7],
